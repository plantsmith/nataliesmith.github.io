...
execute:
  ...
  warning: false
freeze: true
draft: true # "true" will mean this is a draft post so it won't show up on my site
---
...
#subtitle: 
subtitle <- glue::glue("
  <span style='color:#B0C7C1;'>**Point sources**</span> represent single, identifiable locations of emission, while <br> <span style='color:#DE8635;'>**non-point sources**</span> encompass diffuse, widespread pollution origins across the region."
)
...
scale_y_continuous(labels = function(x) paste0(scales::comma(x), " tons")) +  # Adding commas and tons to y-axis labels
