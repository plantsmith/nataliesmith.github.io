...
#subtitle: 
subtitle <- glue::glue("
  <span style='color:#B0C7C1;'>**Point sources**</span> represent single, identifiable locations of emission, while <br> <span style='color:#CC7E62;'>**non-point sources**</span> encompass diffuse, widespread pollution origins across the region."
)
