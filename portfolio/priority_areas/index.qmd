---
title: "Identifying Priority Areas for a Preserve in the Morro Bay Watershed"
...
author: "Natalie Smith & Thuy-Tien Bui"
categories: [GIS, Environmental Justice, Urban, Visualization, Spatial Analysis]
date: 09-21-2024
format:
  html:
    code-fold: true
...
# Rename columns
colnames(table) <- c("Solution Type", "Planning Unit Selection Parameter", "All Species (Acres)", "Endangered Species (Acres)", "Percent Change") 
...
![Figure 1: Priority Reserve Planning Units for All Species and Endangered Species in Morro Bay, California (Best Solution). Selected lowest-cost planning unit solutions compare all species to endangered species. The endangered species representation highlights fewer, more targeted areas for conservation.](best_solution.png){width="600"}

![Figure 2: Priority Reserve Planning Units for All Species and Endangered Species in Morro Bay, California (Summed Solution). A spectrum of lowest-cost planning unit selection frequency compares all species with endangered species. The endangered species representation highlights more targeted areas for conservation compared to the broader selected units for all species.](summed_solution.png){width="600"}
